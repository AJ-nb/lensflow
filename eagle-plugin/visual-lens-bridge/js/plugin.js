(function () {
  ...
  function bindEvents() {
    ...
    el.exportBaseline.addEventListener("click", function () { exportJson(state.baseline, "visual-lens-eagle-baseline.json"); });
  ...
  function exportReport() {
    ...
    exportJson(report, "visual-lens-eagle-result.json");
  }
