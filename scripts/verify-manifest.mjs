...
if (manifest.version !== "0.6.3") failures.push(`version is ${JSON.stringify(manifest.version)}`);
...
if (failures.length > 0) {
  ...
  console.log("Manifest verified: 砚台 v0.6.3, automatic page picker hosts, no startup content scripts.");
}
